...
type Counter = { count: number; owner: string }

const getCounterFields = (data: SuiObjectData): Counter | null =>
  data.content?.dataType === "moveObject"
    ? (data.content.fields as Counter)
    : null
  ...
  return (
    <>
      ...
      <Flex direction="column" gap="2">
        <Text>Count: {getCounterFields(data.data)?.count}</Text>
